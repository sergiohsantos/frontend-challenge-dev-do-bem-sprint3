...
export function SatisfactionCard({ canSubmit, canResubmit, latestScore, disabled, onOpen }: { canSubmit?: boolean; canResubmit?: boolean; latestScore?: number; disabled?: boolean; onOpen: () => void }) {
