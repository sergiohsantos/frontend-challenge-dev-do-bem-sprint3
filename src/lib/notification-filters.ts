...
function isSelfText(title: unknown, message: unknown, description: unknown): boolean {
  ...
  return ["voce enviou", "mensagem enviada por voce", "mensagem enviada por você", "enviada por voce", "enviado por voce", "sent by you", "you sent"].some((pattern) => text.includes(normalizeComparable(pattern)))
}
